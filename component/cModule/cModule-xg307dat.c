...
/// @-1=Disable
#if CONFIG_CMODULE_INSTANCE_X_ENABLE == 80
#define CONFIG_CMODULE_INSTANCE_TAG_ID                    80
#else
#define CONFIG_CMODULE_INSTANCE_TAG_ID                    -1
#endif

#define CONFIG_SERIAL_BAURRATE                             (9600)
...
RILAT_COMMAND_MATCH_DEFINE(_NTP, "+NTP:", data, len) {
    ...
    mModuleInstance.aux.timeStamp = rc;
...
cModule_Instance_t *cModule_getInstance_xg307dat(void) {
