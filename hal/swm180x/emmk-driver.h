...
#include "SWM180_cache.h"               // Synwit::Device:Driver:Cache
#include "SWM180_dma.h"                 // Synwit::Device:Driver:DMA
#include "SWM180_div.h"                 // Synwit::Device:Driver:Div
#include "SWM180_exti.h"                // Synwit::Device:Driver:EXIT
#include "SWM180_flash.h"               // Synwit::Device:Driver:Flash
#include "SWM180_gpio.h"                // Synwit::Device:Driver:GPIO
#include "SWM180_port.h"                // Synwit::Device:Driver:Port
#include "SWM180_pwm.h"                 // Synwit::Device:Driver:PWM
#include "SWM180_sdadc.h"               // Synwit::Device:Driver:SDADC
#include "SWM180_timr.h"                // Synwit::Device:Driver:Timer
#include "SWM180_uart.h"                // Synwit::Device:Driver:UART
#include "SWM180_wdt.h"                 // Synwit::Device:Driver:WDT
#include "SWM180_irqmux.h"              // Synwit::Device:Driver:IRQMux
