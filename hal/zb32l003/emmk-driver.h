...
#define DEVICE_VERSION            "ZB32L003"
...
#define __RCC_REGWR_LOCK()   RCC->UNLOCK = (0x2AD5334C << RCC_UNLOCK_KEY_Pos) & RCC_UNLOCK_KEY
#define __RCC_REGWR_UNLOCK() RCC->UNLOCK = RCC_UNLOCK_UNLOCK | (0x2AD5334C << RCC_UNLOCK_KEY_Pos)
...
extern void kdpwr_devInit_cx32(void);
extern void kdpwr_devInit_clm32(void);
