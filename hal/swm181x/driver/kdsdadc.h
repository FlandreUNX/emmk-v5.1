...
#include "SWM181_sdadc.h"                 // Synwit::Device:Driver:ADC
            ...
            .instance = { \
                ...
                .cfg = { \
                    [0] = { \
                        ...
                        _sdModeA == KDSDADC_SDMODE_DIFF ? ((((((float) _refVolt)) / (2.0f * _convertGaintA)) / 32767.0f)) : ((((float) _refVolt)) / _convertGaintA / 32767.0f) \
                    }, \
                    [1] = { \
                        _sdModeB, _gainB, _refMB, channelsB, \
                        _sdModeB == KDSDADC_SDMODE_DIFF ? ((((((float) _refVolt)) / (2.0f * _convertGaintB)) / 32767.0f)) : ((((float) _refVolt)) / _convertGaintB / 32767.0f) \
                    }, \
                    [2] = { \
                        _sdModeC, _gainC, _refMC, channelsC, \
                        _sdModeC == KDSDADC_SDMODE_DIFF ? ((((((float) _refVolt)) / (2.0f * _convertGaintC)) / 32767.0f)) : ((((float) _refVolt)) / _convertGaintC / 32767.0f) \
                    }, \
                }, \
