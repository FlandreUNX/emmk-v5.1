...
typedef enum {
    KDGPIO_TRIGGER_NONE = EXTI_TRIGGER_NONE,
    KDGPIO_TRIGGER_RISING = EXTI_TRIGGER_RISING,
    KDGPIO_TRIGGER_FALLING = EXTI_TRIGGER_RISING,
    KDGPIO_TRIGGER_RISING_FALLING = EXTI_TRIGGER_RISING_FALLING,
    KDGPIO_TRIGGER_LOW,
    KDGPIO_TRIGGER_HIGH,
...
#define _KDGPIO_PIN_EXTI(_pin)          EXTI_LINE_##_pin
#define _KDGPIO_PIN_EXTI_GPIO(_port)    EXTI_GPIO##_port
...
#define KDGPIO_DEFINE(_port, _pin, _name, \
    ...
    const kdgpio_t _KDGPIO_INAME(_name) = { \
        ...
        ._config = { \
            ...
            .extiConfig = { \
                .eLine = _KDGPIO_PIN_EXTI(_pin), \
                .ePort = _KDGPIO_PIN_EXTI_GPIO(_port), \
            }, \
        }, \
    };
...
extern void _gpio_modeConfig(GPIO_TypeDef * port, uint32_t number, uint32_t pin, kdgpio_Mode_t mode);
