...
typedef enum {
    KDGPIO_TRIGGER_NONE = GPIO_INTR_DISABLE,
    KDGPIO_TRIGGER_RISING = GPIO_INTR_POSEDGE,
    KDGPIO_TRIGGER_FALLING = GPIO_INTR_NEGEDGE,
    KDGPIO_TRIGGER_RISING_FALLING = GPIO_INTR_ANYEDGE,
    KDGPIO_TRIGGER_LOW = GPIO_INTR_LOW_LEVEL,
    KDGPIO_TRIGGER_HIGH = GPIO_INTR_HIGH_LEVEL,
