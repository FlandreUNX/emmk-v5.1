...
#define KDSARADC_INSTANCE_CONTINUE_DEFINE(_instance, _refVolt, \
    ...
    static const kdsaradc_Host_t _KDSARADC_HOST(_instance) = { \
        ...
        .init = { \
            ...
            .dma = { \
                ...
                .channel = _dmaChannel, \
                .init = { \
                    .periph_addr = (uint32_t) (&ADC_RDATA(_KDSARADC_MODULE(_instance))), \
    ...
    void _dmaIrq(void) { \
        dma_interrupt_flag_clear(_KDSARADC_HOST(_instance).init.dma.module, _KDSARADC_HOST(_instance).init.dma.channel, DMA_INT_FLAG_FTF); \
        dma_interrupt_flag_clear(_KDSARADC_HOST(_instance).init.dma.module, _KDSARADC_HOST(_instance).init.dma.channel, DMA_INT_FLAG_ERR); \
    }
