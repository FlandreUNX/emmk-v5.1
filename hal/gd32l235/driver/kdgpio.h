...
typedef enum {
    KDGPIO_MODE_INPUT = 0,
    KDGPIO_MODE_OUTPUT_PP = 1,
    KDGPIO_MODE_OUTPUT_OD = 2,
...
typedef enum {
    KDGPIO_PULL_NONE = GPIO_PUPD_NONE,
    KDGPIO_PULL_UP = GPIO_PUPD_PULLUP,
    KDGPIO_PULL_DOWN = GPIO_PUPD_PULLDOWN,
...
#define _KDGPIO_EXTI_PORT_SOURCE(_port)     EXTI_SOURCE_GPIO##_port
#define _KDGPIO_EXTI_PIN_SOURCE(_pin)       EXTI_SOURCE_PIN##_pin
...
extern void _gpio_afConfig(uint32_t port, uint32_t number, uint32_t pin, uint32_t af);
