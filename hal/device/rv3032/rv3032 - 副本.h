...
typedef enum {
    RV3032_CLKOUT_SEL_32768HZ = 0,
    RV3032_CLKOUT_SEL_1024HZ = 0x20,
    RV3032_CLKOUT_SEL_64HZ = 0x40,
    RV3032_CLKOUT_SEL_1HZ = 0x20 | 0x40,
    RV3032_CLKOUT_SEL_DISABLE = 0xFF,
} RV3032_ClkOutSel_t;

typedef enum {
    RV3032_CHARGER_BSM_DIRECT = 0x10,
    RV3032_CHARGER_BSM_LEVEL = 0x20,
    RV3032_CHARGER_BSM_DISABLED = 0,
    
    RV3032_CHARGER_TCR_1K = 0,
    RV3032_CHARGER_TCR_2K = 0x04,
    RV3032_CHARGER_TCR_7K = 0x08,
    RV3032_CHARGER_TCR_11K = 0x04 | 0x08,
    
    RV3032_CHARGER_TCM_OFF = 0,
    RV3032_CHARGER_TCM_1V75 = 0x01,
    RV3032_CHARGER_TCM_3V0 = 0x02,
    RV3032_CHARGER_TCM_4V4 = 0x01 | 0x02,
...
extern int32_t rv3032_setupClkOut(RV3032_ClkOutSel_t sel);

extern int32_t rv3032_setupCharge(RV3032_Charger_t tcm, RV3032_Charger_t tcr, RV3032_Charger_t bsm);
